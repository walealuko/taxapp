...
export default function EstimatedTaxView() {
  ...
  useEffect(() => {
    const loadEstimate = async () => {
      try {
        ...
        if (currentMonth < 3) targetMonth = 3;
        else if (currentMonth < 6) targetMonth = 6;
        else if (currentMonth < 9) targetMonth = 9;
        else targetMonth = 0;
