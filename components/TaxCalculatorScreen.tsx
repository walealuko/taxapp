...
const styles = {
  ...
  summaryCard: { margin: 16, marginTop: 16 },
  summaryRow: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    paddingVertical: 10,
  ...
  summaryLabelHighlight: { fontSize: 18, fontWeight: 'bold' },
  summaryValueHighlight: { fontSize: 22, fontWeight: 'bold' },
  ...
  infoSectionTitle: (colors) => ({ fontSize: 18, fontWeight: '700', color: colors.text, marginBottom: 12 }),
  infoRow: (colors) => ({
    flexDirection: 'row',
    alignItems: 'flex-start',
    paddingVertical: 8,
  ...
  infoLeft: { flex: 1 },
  infoRange: (colors) => ({ fontSize: 16, fontWeight: '600', color: colors.text }),
  infoRate: (colors) => ({ fontSize: 16, fontWeight: '700', color: colors.primary, minWidth: 50 }),
  ...
  tipsHeaderText: (colors) => ({ fontSize: 18, fontWeight: 'bold', color: colors.text }),
  tipRow: { paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: 'rgba(0,0,0,0.05)' },
  tipLabel: (colors) => ({ fontSize: 16, fontWeight: '600', color: colors.text, marginBottom: 2 }),
