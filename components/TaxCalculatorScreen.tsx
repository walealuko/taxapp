      ...
      <html>
        <head>
          <style>
            ...
            .title { font-size: 24px; font-weight: bold; color: #004a99; }
            ...
            .highlight { background: #f0f7ff; font-weight: bold; color: #004a99; }
            .footer { margin-top: 40px; text-align: center; font-size: 12px; color: #999; border-top: 1px solid #eee; padding-top: 20px; }
          </style>
        </head>
        <body>
          <div class="header">
            <div class="title">NRS Tax Calculation Report</div>
            <div class="subtitle">Tax Type: ${taxInfo?.title || type.toUpperCase()} | Date: ${new Date().toLocaleDateString()}</div>
          </div>
          <div class="section">
            ...
            ${Object.entries(result).map(([key, value]) => {
              ...
              const isHighlight = key.toLowerCase().includes('tax') || key.toLowerCase().includes('income');
              return `
          ...
          <div class="footer">
            Generated by NRS Tax App Nigeria. This is a digitally generated report.
          </div>
        </body>
      </html>
    `;
