...
const styles = StyleSheet.create({
  ...
  metricLabel: { fontSize: 16, fontWeight: '500' },
  metricValue: { fontSize: 16, fontWeight: '600', textAlign: 'center' },
  metricValueHighlight: { fontSize: 18, fontWeight: '800', textAlign: 'center' },
